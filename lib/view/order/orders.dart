...
class Orders extends StatefulWidget {
  final DateTime date;
  const Orders({Key? key,required this.date}) : super(key: key);
  @override
                                                    ...
                                                    children: [
                                                      InkWell(
                                                        onTap: () {
                                                          ...
                                                          // Navigator.pushReplacement(context,  MaterialPageRoute(builder: (context) => ModifyOrder(orderId: orders[0].id, lineId: orderLine.id, dateTime: selectedDate,)));
                                                        },
                                                        child: Row(
                                                          children: [
                                                            Icon(
                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                      InkWell(
                                                        onTap: () {
                                                          gotosubsciption();
                                                          // Navigator.pushReplacement(context,  MaterialPageRoute(builder: (context) => MySubscription()));
                                                        },
                                                        child: Row(
                                                          children: [
                                                            Icon(
