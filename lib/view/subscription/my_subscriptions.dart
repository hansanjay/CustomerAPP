...
import 'package:client_flutter_master/view/dashboard/home_fragment.dart';
                                              ...
                                              if (!subsProduct.permanent)
                                                Column(
                                                  children: [
                                                    ...
                                                    Text(
                                                      "Your subscription has been modified from " +
                                                          subsProduct.start
                                                              .toString()
                                                              .substring(
                                                                  0, 10) +
                                                          ...
                                                          subsProduct.stop
                                                              ...
                                                              .substring(
                                                                  0, 10) +
                                                          ". You can resume to continue the services",
                                                      style: TextStyle(
                                                          fontSize: 9,
                                                          fontWeight:
                                                              FontWeight.normal,
                                                              ...
                                                              Expanded(
                                                                child: Container(
                                                                    child: new OutlinedButton(
                                                                        ...
                                                                        child: new Text(VariableUtils.prmtly, style: TextStyle(color: Colors.white, fontSize: 10)),
                                                                        onPressed: () {
                                                                          Navigator.pop(
                                                                              context);
                                                                          Navigator.push(
