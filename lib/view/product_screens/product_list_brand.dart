...
class ProductListBrand extends StatefulWidget {
  final String brand;
  const ProductListBrand({Key? key, required this.brand}) : super(key: key);
  @override
...
class _ProductListBrandState extends State<ProductListBrand> {
  ...
  print("ProductCategory::"+url);
       print("ProductCategory::"+appId);
        ...
        setState(() {
          ...
          for (var product in data['products']) {
            ...
            if (product['brand'] == widget.brand) {
              String subCategory = product['category'] ?? 'All';
                              ...
                              child: ListView(
                                children:
                                  ...
                                  var product = _products[index];
                                    print("product::"+ "$baseUrl/" +product.imageUrl);
